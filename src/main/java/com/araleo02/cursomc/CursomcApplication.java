...
public class CursomcApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Categoria cat7 = new Categoria(null, "Higiene");
		Categoria cat8 = new Categoria(null, "Decoracao");
		Categoria cat9 = new Categoria(null, "Infantil");
		Categoria cat10 = new Categoria(null, "Moda");
		Categoria cat11 = new Categoria(null, "Escolar");
		Categoria cat12 = new Categoria(null, "Sexual");
		...
		categoriaRepository.save(Arrays.asList(cat1, cat2,cat3,cat4,cat5,cat6,cat7,cat8,cat9,cat10,cat11,cat12));
